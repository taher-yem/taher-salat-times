...
public class one {
    ...
    private static String strTime; // StrTime
    ...
    public one() {
        ...
        timeNames.add("Sihori Ends");
        timeNames.add("Sunrise");
        timeNames.add("Zawaal");
        timeNames.add("Asr");
        timeNames.add("Fajr Starts");
        timeNames.add("Maghrib");
        timeNames.add("Zuhr Ends");
    ...
    private double computeTime(double G, double t) {
        ...
        double Beg = -dsin(G) - dsin(D) * dsin(one.getLat());
        double Mid = dcos(D) * dcos(one.getLat());
    ...
    private double computeAsr(double step, double t) {
        double D = sunDeclination(this.getJDate() + t);
        double G = -darccot(step + dtan(Math.abs(one.getLat() - D)));
    ...
    private double[] adjustTimes(double[] times) {
        for (int i = 0; i < times.length; i++) {
            times[i] += this.getTimeZone() - one.getLng() / 15;
        }
    ...
    public static String Position(Location loc)
    {
    ...
    public static void mainApp() {
        ...
        prayers.setAsrJuristic(prayers.Karachi);
        prayers.setAdjustHighLats(prayers.AngleBased);
        int[] offsets = {19, -2, -1, 0, -661, -1, -301}; // {Fajr,Sunrise,Dhuhr,Asr,Sunset,Maghrib,Isha}
        ...
        for (int i = 0; i < prayerTimes.size(); i++) {
            System.out.println(prayerNames.get(i) + " - " + prayerTimes.get(i));
        	  ...
        	  setStrTime(prayerNames.get(0) + " - " + prayerTimes.get(0) 
        		+ "\n" + prayerNames.get(4) + " - " + prayerTimes.get(4)
        		+ "\n" + prayerNames.get(1) + " - " + prayerTimes.get(1)
        		+ "\n" + prayerNames.get(2) + " - " + prayerTimes.get(2) 
        		+ "\n" + prayerNames.get(6) + " - " + prayerTimes.get(6)
        		+ "\n" + prayerNames.get(3) + " - " + prayerTimes.get(3)
        		+ "\n" + prayerNames.get(5) + " - " + prayerTimes.get(5));
...
///////////////////////////////////////////////////////
    ...
    public static void setStrTime(String ss) {
    	strTime = ss;
    }
//////////////////////////////////////////////////////
    ...
    public static void setLat(double latt) {
        lat = latt;
    }
    ...
    public static void setLng(double lngg) {
        lng = lngg;
    }
